...
## format
overview[V1 %like% "\\.$" & !(V1 %like% "i\\.e\\.$"), id:=1:nrow(overview[V1 %like% "\\.$" & !(V1 %like% "i\\.e\\.$")])]
...
## save
write.csv(overview, paste0(wd_path, package_name, "/doc/function_overview.csv"), row.names=F)
